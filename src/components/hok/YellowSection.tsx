  ...
  return (
    <HorizontalScrollLock heading="BRANDS ON BOARD" bg="bg-hok-yellow">
      {Array.from({ length: 8 }).map((_, i) => (
        <div
          key={i}
          /* Added the missing w-[68vw] right here so it matches the ShopAllTile exactly! */
          className="relative aspect-[3/4] w-[68vw] sm:w-[40vw] md:w-[28vw] lg:w-[24vw] shrink-0 rounded-2xl border-2 border-dashed border-hok bg-white/40 flex items-center justify-center"
        >
